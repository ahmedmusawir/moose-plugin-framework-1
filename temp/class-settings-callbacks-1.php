...
class SettingsCallbacks {
	...
	public function jwValidateOptions( $input ) {
		...
		// print_r($_FILES);
		// print_r($_FILES['jw_options']['name']);
		// print_r($_FILES['jw_options']);

			// $override = array('test_form' => false);
			// $file = wp_handle_upload( $_FILES['jw_options'], $override );

			// print_r($file);	

		    // print_r($_FILES['jw_options_custom_image']);
	...
	public function jwCallbackFieldImage( $args ) {
		...
		// echo '<input type="file" id="jw_options_'. $id .'" name="jw_options['. $id .']" ><br />';
		...
		// echo $_FILES['jw_options_custom_image'];
	}
